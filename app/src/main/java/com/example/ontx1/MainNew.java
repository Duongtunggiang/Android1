...
public class MainNew extends AppCompatActivity {
    ...
    public void getWidget() {
        ...
        adapter = new ArrayAdapter<BaoThuc>(MainNew.this, android.R.layout.simple_list_item_1, bts);
        lv.setAdapter(adapter);

        cal = Calendar.getInstance();

        adapterDate = new ArrayAdapter<String>(MainNew.this, android.R.layout.simple_spinner_item, arr);
    ...
    private class MyProcessEvent implements AdapterView.OnItemSelectedListener {
        ...
        public void onNothingSelected(AdapterView<?> parent) {
            Toast.makeText(MainNew.this, "Bat buoc phai chon ngay", Toast.LENGTH_LONG).show();
            return;
        }
    }
...
//                String s = hourOfDay+":"+minute;
        ...
        TimePickerDialog time = new TimePickerDialog(MainNew.this, callback, timeDefault.getHours(), timeDefault.getMinutes(), true);
    ...
    public void setEventItem() {
        ...
        lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                AlertDialog.Builder b = new AlertDialog.Builder(MainNew.this);
    ...
    public class DoSomething implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            if (v.getId() == R.id.btnUpdate) {
                if (pos == -1) {
                    Toast.makeText(MainNew.this, "Bao thuc khong hop le!", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (txtName.isEmpty()) {
                    Toast.makeText(MainNew.this, "Ten bao thuc khong duoc de trong", Toast.LENGTH_LONG).show();
                    return;
                }

                if (dateContent.equals("Chon ngay")) {
                    Toast.makeText(MainNew.this, "Phai chon ngay bao thuc", Toast.LENGTH_LONG).show();
                    return;
                }

                String txtTime = time.getText() + "";
                if (txtTime.isEmpty()) {
                    Toast.makeText(MainNew.this, "Gio khong duoc de trong", Toast.LENGTH_LONG).show();
                    return;
                }
                String txtLoop = "";
                if (loop.isChecked()) {
                ...
                if (chkGrBuoi == -1) {
                    Toast.makeText(MainNew.this, "Phai chon buoi bao thuc (Sang/Chieu)", Toast.LENGTH_LONG).show();
                    return;
                }
